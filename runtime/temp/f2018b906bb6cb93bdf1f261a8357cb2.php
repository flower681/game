<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/www.daodao.cn.com/public/../application/admin/view/login.html";i:1553964808;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="signinpanel">
    ...
    <div class="signup-footer" style="margin-top:150px;">
        <div class="" style="text-align:center" >
            <a href="" target="_blank" style="color:#ffffff;">请正确使用，不要违法使用，祝大家发发发</a>
        </div>
    </div>
</div>
