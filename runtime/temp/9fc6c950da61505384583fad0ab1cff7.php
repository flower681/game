<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/www/wwwroot/www.daodao.cn.com/public/../application/admin/view/games/gamesEdit.html";i:1532424450;s:65:"/www/wwwroot/www.daodao.cn.com/application/admin/view/header.html";i:1532410270;s:65:"/www/wwwroot/www.daodao.cn.com/application/admin/view/footer.html";i:1532410270;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" onsubmit="return toVaild()">
                        <input type="hidden" name="gs_id" value="<?php echo $games['gs_id']; ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">游戏名称：</label>
                            <div class="input-group col-sm-4">
                                <input type="text" class="form-control" name="gs_name" required="" aria-required="true" value="<?php echo $games['gs_name']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">游戏包名：</label>
                            <div class="input-group col-sm-4">
                                <input type="text" class="form-control" required="" aria-required="true" value="<?php echo $games['productIdentifier']; ?>" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">游戏详情：</label>
                            <div class="input-group col-sm-4">
									<textarea id="content15" name="gs_content"
                                              class="form-control common-text"
                                              style="width: 100%; height: 100px;"><?php echo $games['gs_content']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                ...
                                <div class="radio i-checks col-sm-4">
                                    <label>
                                        <input type="radio" value="<?php echo $key; ?>" <?php if($key == $games['gs_status']): ?>checked<?php endif; ?> name="gs_status"> <i></i> <?php echo $vo; ?></label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                ...
                                <div class="radio i-checks col-sm-4">
                                    <label>
                                        <input type="radio" value="<?php echo $key; ?>" <?php if($key == $games['receipt_type']): ?>checked<?php endif; ?> name="receipt_type"> <i></i> <?php echo $vo; ?></label>
                                </div>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
                        </div>
