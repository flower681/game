<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"E:\wamp\phpStudy\PHPTutorial\WWW\game\public/../application/admin\view\role\index.html";i:1532410270;s:72:"E:\wamp\phpStudy\PHPTutorial\WWW\game\application\admin\view\header.html";i:1532410270;s:72:"E:\wamp\phpStudy\PHPTutorial\WWW\game\application\admin\view\footer.html";i:1532410270;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <a href="./roleAdd"><button class="btn btn-outline btn-primary" type="button">添加团队</button></a>
            </div>
            <!--搜索框开始-->
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable" data-height="500">
                        <thead>
                        <th data-field="id">团队ID</th>
                        <th data-field="rolename">团队名称</th>
