<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/www/wwwroot/www.daodao.cn.com/public/../application/admin/view/index/forwardWeb.html";i:1532424450;s:65:"/www/wwwroot/www.daodao.cn.com/application/admin/view/header.html";i:1532410270;s:65:"/www/wwwroot/www.daodao.cn.com/application/admin/view/footer.html";i:1532410270;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal m-t" id="commentForm" method="post" onsubmit="return toVaild()">
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-5">
                                <input id="" type="number" class="form-control" name="" required="" aria-required="true" value="<?php echo $user['money']; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-5">
                                <textarea name=""  cols="30" rows="5" class="form-control" readonly><?php echo $user['desc']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
