<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"E:\wamp\phpStudy\PHPTutorial\WWW\game\public/../application/admin\view\games\index.html";i:1559721731;s:72:"E:\wamp\phpStudy\PHPTutorial\WWW\game\application\admin\view\header.html";i:1559721731;s:72:"E:\wamp\phpStudy\PHPTutorial\WWW\game\application\admin\view\footer.html";i:1559721731;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
	...
	<div class="ibox float-e-margins">
		...
		<div class="ibox-content">
			<div class="form-group clearfix col-sm-1">
				<a href="./gamesAdd"><button class="btn btn-outline btn-primary" type="button">添加游戏</button></a>
			</div>
			<!--搜索框开始-->
			<form id='commentForm' role="form"  class="form-inline">
				<div class="content clearfix m-b">
					...
					<div class="form-group ">
						<label>游戏名称：</label>
						<input size="10" type="text" class="  form-control " id="gamesName" style="width: 150px;">
					</div>
			...
			<div class="example-wrap">
				<div class="example">
					<table id="cusTable" data-height="700">
						<thead>
						<th data-field="gs_id">游戏ID</th>
						<th data-field="gs_name">游戏名称</th>
						<th data-field="productIdentifier">游戏包名</th>
						<th data-field="gs_content">游戏备注</th>
						<th data-field="gs_status">当前状态</th>
...
<script type="text/javascript">
    ...
    function gamesDel(id){
        layer.confirm('确认删除此游戏?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON('./gamesDel', {'gs_id' : id}, function(res){
                if(res.code == 1){
