<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/www.daodao.cn.com/public/../application/admin/view/index.html";i:1554020500;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation" >
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="menu active" style="background:#337ab7">
                  <!--
                <a href="<?php echo $vo['href']; ?>" style="font-size: 16px;pointer-events: none;">
                    <i class="<?php echo $vo['style']; ?>"></i>
                    <span class="nav-label"><?php echo $vo['node_name1']; ?> </span>
...
-->
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a class="J_menuItem" href="<?php echo $v['href']; ?>" style="font-size: 15px;"><?php echo $v['node_name']; ?></a>
                    </li>
