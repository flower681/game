<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"/www/wwwroot/193.38.139.70/public/../application/admin/view/help/helpEdit.html";i:1532424450;s:61:"/www/wwwroot/193.38.139.70/application/admin/view/header.html";i:1532410270;s:61:"/www/wwwroot/193.38.139.70/application/admin/view/footer.html";i:1532410270;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" onsubmit="return toVaild()">
                        <input type="hidden" name="hp_id" value="<?php echo $help['hp_id']; ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">帮助标题：</label>
                            <div class="input-group col-sm-4">
                                <input id="username" type="text" class="form-control" name="hp_name" required="" aria-required="true" value="<?php echo $help['hp_name']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
									<textarea id="content15" name="hp_content"
                                              ...
                                              style="width: 100%; height: 100px;"><?php echo $help['hp_content']; ?></textarea>
                            </div>
                            <script>
                                KindEditor
                                    .ready(function(K) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                ...
                                <div class="radio i-checks col-sm-4">
                                    <label>
                                        <input type="radio" value="<?php echo $key; ?>" <?php if($key == $help['hp_status']): ?>checked<?php endif; ?> name="hp_status"> <i></i> <?php echo $vo; ?></label>
                                </div>
...
<script type="text/javascript"> 
    ...
    function toVaild(){
        ...
        $.ajax({
            type:"POST",
            url:url,
            data:{'data' : $('#commentForm').serialize(),'content':$('#content15').val()},// 你的formid
            async: false,
            beforeSend:function(){
