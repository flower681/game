<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"E:\wamp\phpStudy\PHPTutorial\WWW\game\public/../application/admin\view\index.html";i:1559812402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <!--<li>-->
                    ...
                    <!--<ul>-->
                        <!--<li>-->
                            <!--<a class="J_menuItem" href="<?php echo url('admin/index/chat'); ?>" data-index="0">chat</a>-->
                        <!--</li>-->
                    <!--</ul>-->
                <!--</li>-->
    ...
    <!--<div id="small-chat">-->
        ...
        <!--<a class="open-small-chat" onclick="chat()">-->
            <!--<i class="fa fa-comments"></i>-->
        <!---->
        <!--</a>-->
        <!--&lt;!&ndash;<a onclick="chat()"></a>&ndash;&gt;-->
    <!--</div>-->
     ...
     */
     function chat(){
	    layer.open({
		    ...
		    content: ["<?php echo url('index/chat'); ?>"], //iframe的url，no代表不显示滚动条
	    });
    }
