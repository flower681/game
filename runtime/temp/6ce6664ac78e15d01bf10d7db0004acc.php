<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"/www/wwwroot/193.38.139.70/public/../application/admin/view/notice/noticeEdit.html";i:1532424450;s:61:"/www/wwwroot/193.38.139.70/application/admin/view/header.html";i:1532410270;s:61:"/www/wwwroot/193.38.139.70/application/admin/view/footer.html";i:1532410270;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" onsubmit="return toVaild()">
                        <input type="hidden" name="ne_id" value="<?php echo $notice['ne_id']; ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">公告标题：</label>
                            <div class="input-group col-sm-4">
                                <input type="text" class="form-control" name="ne_name" required="" aria-required="true" value="<?php echo $notice['ne_name']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">公告详情：</label>
                            <div class="input-group col-sm-4">
                                <textarea id="content15" name="ne_content"
                                          class="form-control common-text"
                                          style="width: 100%; height: 100px;"><?php echo $notice['ne_content']; ?>
                                </textarea>
                                <script>
                                    KindEditor
                                        .ready(function(K) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                ...
                                <div class="radio i-checks col-sm-4">
                                    <label>
                                        <input type="radio" value="<?php echo $key; ?>" <?php if($key == $notice['ne_status']): ?>checked<?php endif; ?> name="ne_status"> <i></i> <?php echo $vo; ?></label>
                                </div>
