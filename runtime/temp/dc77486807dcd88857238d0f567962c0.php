<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/data/wwwroot/default/public/../application/admin/view/index/forgetPass.html";i:1532412664;s:56:"/data/wwwroot/default/application/admin/view/header.html";i:1532410271;s:56:"/data/wwwroot/default/application/admin/view/footer.html";i:1532410271;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal m-t" id="commentForm" method="post" onsubmit="return toVaild()">
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="old_pass" type="text" class="form-control" name="old_pass"  placeholder="请输入旧密码" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">新的密码：</label>
                            <div class="input-group col-sm-4">
                                <input id="new_pass" type="text" class="form-control" name="new_pass" placeholder="请输入新密码" required="" aria-required="true" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">确认密码：</label>
                            <div class="input-group col-sm-4">
                                <input id="password" type="text" class="form-control" name="password" placeholder="请确认新密码"required="" aria-required="true" value="">
                            </div>
                        </div>
                        <div class="form-group">
