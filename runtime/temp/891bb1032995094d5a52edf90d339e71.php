<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"E:\wamp\phpStudy\PHPTutorial\WWW\game\public/../application/admin\view\stock2\index.html";i:1555212019;s:72:"E:\wamp\phpStudy\PHPTutorial\WWW\game\application\admin\view\header.html";i:1532410270;s:72:"E:\wamp\phpStudy\PHPTutorial\WWW\game\application\admin\view\footer.html";i:1532410270;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <form id='commentForm' role="form" class="form-inline" action="<?php echo url('stock/exportStock'); ?>" method="post">
                <div class="content clearfix m-b" style="line-height: 50px;">
                    ...
                    <div class="form-group ">
                        <label>库存单号：</label>
                        <input size="10" type="text" class="  form-control " id="orderId" name="orderId"
                               style="width: 150px;">
                    </div>
                    <div class="form-group ">
                        <label>所属用户：</label>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.pl_pp').click(function(){
            ...
            pp_ids=pp_ids.slice(0,pp_ids.length-1);
            if(pp_ids.length==0){
                layer.msg('请选择需要匹配的数据');
                return;
            }
            $.post("<?php echo url('Stock2/pipei_admin'); ?>",{'uid':pp_uid,'ids':pp_ids},function(res){
                layer.msg(res.msg);
                initTable();
            });
    ...
    function inputSelect() {
        ...
        var url = "<?php echo url('stock2/itemizeList'); ?>";
        //发送请求处理 处理数据
