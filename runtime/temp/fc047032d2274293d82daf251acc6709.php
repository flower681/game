<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/www/wwwroot/www.daodao.cn.com/public/../application/admin/view/user/userAdd.html";i:1532410270;s:65:"/www/wwwroot/www.daodao.cn.com/application/admin/view/header.html";i:1532410270;s:65:"/www/wwwroot/www.daodao.cn.com/application/admin/view/footer.html";i:1532410270;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" onsubmit="return toVaild()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="really_name" type="text" class="form-control" name="really_name" required="" aria-required="true">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="idcard" type="text" class="form-control" name="idcard" required="" aria-required="true">
