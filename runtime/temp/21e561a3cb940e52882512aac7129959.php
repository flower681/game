<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/www/wwwroot/193.38.139.70/public/../application/admin/view/help/index.html";i:1532424450;s:61:"/www/wwwroot/193.38.139.70/application/admin/view/header.html";i:1532410270;s:61:"/www/wwwroot/193.38.139.70/application/admin/view/footer.html";i:1532410270;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
	...
	<div class="ibox float-e-margins">
		...
		<div class="ibox-content">
			<div class="form-group clearfix col-sm-1">
				<a href="./helpAdd"><button class="btn btn-outline btn-primary" type="button">添加帮助</button></a>
			</div>
			<!--搜索框开始-->
			<form id='commentForm' role="form"  class="form-inline">
				<div class="content clearfix m-b">
					...
					<div class="form-group ">
						<label>帮助标题：</label>
						<input size="10" type="text" class="  form-control " id="hp_name">
					</div>
					<div class="form-group ">
						<label>开始日期：</label>
			...
			<div class="example-wrap">
				<div class="example">
					<table id="cusTable" data-height="700">
						<thead>
						<th data-field="hp_id">帮助ID</th>
						<th data-field="hp_name">帮助标题</th>
...
<script type="text/javascript">
    ...
    function helpDel(id){
        layer.confirm('确认删除此帮助?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON('./helpDel', {'hp_id' : id}, function(res){
                if(res.code == 1){
