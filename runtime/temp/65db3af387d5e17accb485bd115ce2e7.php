<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"/www/wwwroot/193.38.139.70/public/../application/admin/view/index.html";i:1532430546;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header" style="border-bottom: 1px solid #19aa8d; height: 120px;">
                    <div class="dropdown profile-element">
                        <!--<span><img alt="image"  src="__IMG__/logo1.png"/></span>-->
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear">
                                <span class="block m-t-xs"><strong class="font-bold" style="font-size: 26px;"><?php echo $username; ?></strong></span>
                                <span class="text-muted text-xs block" style="font-size: 20px;"><?php echo $rolename; ?><b class="caret"></b></span>
                            </span>
                        </a>
                ...
                <li class="menu" style="border-bottom: 0.5px solid #19aa8d; /*background-image: url('__STATIC__/admin/images/left_bar.png')*/">
                <a href="<?php echo $vo['href']; ?>" style="font-size: 18px;">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a class="J_menuItem" href="<?php echo $v['href']; ?>" style="font-size: 16px;"><?php echo $v['node_name']; ?></a>
                    </li>
            ...
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <!-- <marquee direction="left" width="170%" >
                        <b style="font-size: 17px">欢迎使用591库存管理平台，有问题请联系客服微信：<span style="color: red">luokeke1990512</span></b>
                    </marquee> -->
                </div>
