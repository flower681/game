<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"E:\wamp\phpStudy\PHPTutorial\WWW\game\public/../application/admin\view\index\chatAll.html";i:1560165361;}*/ ?>
<html><head>
	...
	<script type="text/javascript">
		...
		function onopen()
		{
			$.ajax({
				...
				success:function(res){
					...
					client_id = res.id;
					// 登录
					var login_data = '{"type":"login","user_id":"'+client_id+'","client_name":"'+name.replace(/"/g, '\\"')+'","room_id":"<?php echo isset($_GET['room_id']) ? $_GET['room_id'] : 1?>"}';
		...
		function say(from_client_id, from_client_name, content, time){
			...
			$.ajax({
				type:'get',
				url:'<?php echo url("admin/index/getAllMsg"); ?>',
				success:function(ret){
					console.log(ret);
...
<div class="container" >
	<div class="row clearfix">
		...
		<div class="col-md-3 column">
			...
			<!--<a href="http://workerman.net:8383" target="_blank"><img style="width:252px;margin-left:5px;" src="/static/Web/img/workerman-todpole.png"></a>-->
		</div>
	</div>
</div>
